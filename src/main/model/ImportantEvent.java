...
public class ImportantEvent extends HighlightEvent{
	private String name;
	private String type;
	...
	public ImportantEvent(String name, String type, int dueMonth, int dueDay, boolean isCompleted) {
		setName(name);
		this.type = type;
	...
	public String toString() {
		return super.toString()+"Important event!\r\n";
	}
}
